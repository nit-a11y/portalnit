    ...
    <div className="min-h-screen bg-gray-50 font-sans">
          ...
          {view === 'admin' && isAdminAuthenticated && (
            ...
            >
              <div className="flex justify-between items-center mb-12">
                ...
                <button 
                  onClick={() => {
                    setEditingProject({ id: 0, title: '', tag: '', description: '', impact: '', image_url: '' });
              ...
              <div className="grid grid-cols-1 gap-6">
                {projects.map((project) => (
                  <div key={project.id} className="glass-card p-6 flex items-center justify-between gap-6">
                    <div className="flex items-center gap-6">
                      <img src={project.image_url} className="w-20 h-20 rounded-xl object-cover" referrerPolicy="no-referrer" />
                      <div>
                        <span className="text-[10px] font-bold uppercase tracking-widest text-nit-red">{project.tag}</span>
                    ...
                    <div className="flex items-center gap-3">
                      <button 
                        ...
                        className="p-3 rounded-xl bg-gray-50 text-gray-400 hover:text-nit-red hover:bg-red-50 transition-all"
                      >
                        <Edit2 size={20} />
                      </button>
                      <button 
      ...
      <footer className="bg-white border-t border-gray-100 py-12 mt-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div 
            className="flex items-center justify-center gap-2 mb-6 opacity-50 cursor-pointer select-none"
            onClick={handleNitClick}
          >
            <div className="w-6 h-6 bg-nit-dark rounded flex items-center justify-center text-white">
              <Lightbulb size={14} />
            </div>
            <span className="font-bold tracking-tighter">NIT</span>
          </div>
          <p className="text-xs text-gray-400 font-bold uppercase tracking-widest mb-2">Nordeste Locações © 2026</p>
          <p className="text-xs text-gray-400">Núcleo de Inteligência e Tecnologia - Inovando para transformar.</p>
        </div>
      </footer>
        ...
        {showPasswordModal && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            <motion.div 
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="absolute inset-0 bg-nit-dark/80 backdrop-blur-sm"
            ...
            >
              <div className="text-center mb-8">
                <div className="w-16 h-16 bg-red-50 text-nit-red rounded-full flex items-center justify-center mx-auto mb-4">
                  <Lock size={32} />
                </div>
                <h2 className="text-2xl font-black">Acesso Restrito</h2>
                <p className="text-gray-400">Insira a senha administrativa para continuar.</p>
              </div>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              <div className="flex justify-between items-center mb-8">
                <h2 className="text-2xl font-black">{editingProject.id ? 'Editar Projeto' : 'Novo Projeto'}</h2>
              ...
              <form onSubmit={handleSaveProject} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="label-text">Categoria (Tag)</label>
                    <input 
                      required 
                ...
                <div>
                  ...
                  <input 
                    ...
                    className="input-field" 
                    placeholder="Ex: Redução de 40% no tempo..." 
                  />
                </div>
                <button type="submit" className="btn-primary w-full py-4">
                  Salvar Projeto
